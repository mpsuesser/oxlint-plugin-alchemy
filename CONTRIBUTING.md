# Contributing to oxlint-plugin-alchemy
...
```sh
git clone https://github.com/mpsuesser/oxlint-plugin-alchemy.git
cd oxlint-plugin-alchemy
bun install
```
...
Use the [GitHub issue templates](https://github.com/mpsuesser/oxlint-plugin-alchemy/issues/new/choose) for bug reports and feature requests.
